...
import {
    IonContent, IonHeader, IonToggle, IonList, IonListHeader, IonPage, IonChip, IonTitle, IonToolbar,
    IonCard, IonGrid, IonRow, IonCol, IonCardHeader, IonCardSubtitle, IonCardTitle, IonCardContent, IonItem, IonIcon, IonLabel, IonButton
} from '@ionic/react';
...
const HomePage: React.FC = () => {
    ...
    let redirectTo = location.state === undefined || location.state.from === undefined ? '/swipe' : location.state.from;

    if (userService.isLoggedIn()) return (<Redirect to={redirectTo} />);
